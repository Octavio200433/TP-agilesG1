...
- Name: features\letra-repetida.feature.spec.js >> Letra repetida >> El jugador ingresa una letra que ya había intentado
- Location: .features-gen\features\letra-repetida.feature.spec.js:6:7
...
Locator: getByTestId('warning')
Expected: "Ya intentaste con esa letra"
Timeout: 5000ms
Error: element(s) not found

Call log:
  - Expect "toHaveText" with timeout 5000ms
  - waiting for getByTestId('warning')

```

```yaml
- heading "Juego del Ahorcado" [level=1]
- heading "_ A _ _" [level=2]
- paragraph: "Vidas: 6"
- textbox "Letra"
```
