...
- Name: features\entrada-invalida.feature.spec.js >> AT 7 — Entrada inválida >> Caso B - Ingresar más de un carácter es rechazado y jugar terminado no afecta (Red 2)
- Location: .features-gen\features\entrada-invalida.feature.spec.js:13:7
...
Call log:
  ...
  - waiting for getByTestId('word')
    14 × locator resolved to <h2 data-testid="word">C _ _ _</h2>
       - unexpected value "C _ _ _"

```

```yaml
- heading "C _ _ _" [level=2]
```
